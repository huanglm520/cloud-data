...
<head>
    ...
    <title>注册用户(第3/4步) - Cloud-Data 数据一体化管理平台</title>
...
<body>
	<div class="topbar">
		<div class="topbarinner">
			...
			<div class="user">
				<span class="user">注册用户(第3/4步)</span>
			</div>
		</div>
	</div>
    <div class="passport">
    	...
    	<div class="info">
    		...
    		<div class="bottom">
    			<div class="b_left">
    				<a href="<%=path%>/passport/register/step2"><span class="bottom">返回上一步</span></a>
    			</div>
    			<div class="b_right">
    ...
    <script type="text/javascript">
	    ...
	    $("#getvercode").click(function() {
    		...
    		// 向后台申请验证码
    		$.ajax({
    			url: "<%=path %>/passport/register/vercode/",
    			type: "POST",
    			timeout: 5000,
    			async: true,
    			dataType: "json",
    ...
    <script type="text/javascript">
    	...
    	function submit() {
    		...
    		// 发起请求
    		$.ajax({
    			url: "<%=path %>/passport/register/step3/",
    			type: "POST",
    			timeout: 5000,
    			async: true,
    			...
    			success: function(data, textStatus) {
    				if (data.code == Code["OK"]) {
    					window.location.href = "<%=path%>/passport/register/step4";
    				} else {
