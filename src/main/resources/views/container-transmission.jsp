...
<head>
    ...
    <title>数据管理 - Cloud-Data 数据一体化服务平台</title>
	...
	<div class="content"  id="content">
	 	<div class="db" v-for="site in json">
			...
			<div style="position: absolute;z-index: 1">
				...
				<div class="cstatus">
					<span class="cstatus">{{ site.data }}&nbsp;条数据</span>
				</div>
				<div class="cprivilege">
					<span class="cprivilege">{{ site.privileges }}</span>
				</div>
			</div>
			<div class="override" onmouseover='$(this).animate({"background-color": "rgba(255,255,255,0.3)"}, 200);' onmouseout='$(this).animate({"background-color": "rgba(255,255,255,0)"}, 200);' @click='window.location.href="<%=path %>/container/transmission/main?cid="+site.id'></div>
		</div>
	</div>
