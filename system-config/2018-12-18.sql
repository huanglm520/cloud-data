...
-- ----------------------------
INSERT INTO `tb_container` VALUES (28, 'test1', 'test1_cd', 1, 1, 0, 1544742796233);
INSERT INTO `tb_container` VALUES (29, 'test2', 'test2_cd', 2, 1, 0, 1544742835506);
INSERT INTO `tb_container` VALUES (30, 'test3', 'test3_cd', 3, 1, 0, 1544742848096);
INSERT INTO `tb_container` VALUES (31, 'test4', 'test4_cd', 4, 1, 0, 1544742855523);
INSERT INTO `tb_container` VALUES (32, 'test5', 'test5_cd', 4, 1, 0, 1544742858944);
INSERT INTO `tb_container` VALUES (33, 'test1', 'test1_cd', 4, 1, 0, 1544766674728);
...
-- ----------------------------
INSERT INTO `tb_container_privilege` VALUES (26, 11, 28, 1);
INSERT INTO `tb_container_privilege` VALUES (27, 11, 29, 1);
INSERT INTO `tb_container_privilege` VALUES (28, 11, 30, 1);
INSERT INTO `tb_container_privilege` VALUES (29, 11, 31, 1);
INSERT INTO `tb_container_privilege` VALUES (30, 11, 32, 1);
INSERT INTO `tb_container_privilege` VALUES (31, 12, 33, 1);
...
-- ----------------------------
-- Table structure for zb_41ayhmfufgmeir54f0qjma==
-- ----------------------------
DROP TABLE IF EXISTS `zb_41ayhmfufgmeir54f0qjma==`;
CREATE TABLE `zb_41ayhmfufgmeir54f0qjma==`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for zb_9nawnavcc+2dbzhljylo1g==
-- ----------------------------
DROP TABLE IF EXISTS `zb_9nawnavcc+2dbzhljylo1g==`;
CREATE TABLE `zb_9nawnavcc+2dbzhljylo1g==`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for zb_cmu+re9ilkxptp9nvt1czg==
-- ----------------------------
DROP TABLE IF EXISTS `zb_cmu+re9ilkxptp9nvt1czg==`;
CREATE TABLE `zb_cmu+re9ilkxptp9nvt1czg==`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for zb_hp13sat1ikaflpt0imhuma==
-- ----------------------------
DROP TABLE IF EXISTS `zb_hp13sat1ikaflpt0imhuma==`;
CREATE TABLE `zb_hp13sat1ikaflpt0imhuma==`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for zb_ofdf68c6nelcpulb5k2xpw==
-- ----------------------------
DROP TABLE IF EXISTS `zb_ofdf68c6nelcpulb5k2xpw==`;
CREATE TABLE `zb_ofdf68c6nelcpulb5k2xpw==`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for zb_wcrtom6ojicw9vo4yvsmcq==
-- ----------------------------
DROP TABLE IF EXISTS `zb_wcrtom6ojicw9vo4yvsmcq==`;
CREATE TABLE `zb_wcrtom6ojicw9vo4yvsmcq==`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
